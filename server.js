 ...
 * ✅ กฎบทพูด:
 *    - ถ้ามี "ประโยคบทพูดหลักของนักแสดง" จากผู้ใช้ → ให้ใช้ข้อความนั้นในข��[...]
...
หน้าที่ของคุณคือ "จัดโครง Prompt ให้เป็นหัวข้อ 1–14 แบบเดิมให้ครบทุกข้อ" สำห��[...]

ให้ตอบ "เป็นภาษาไทยทั้งหมด" ยกเว้นชื่อหัวข้อภาษาอังกฤษในวงเล็บที่กำห[...]
...
- ทุกข้อจะต้องมีเนื้อหาครบ (ห้ามเว้นว่าง) ถึงแม้ผู้ใช้จะไม่ได้ให้ข้อม�[...]
...
1) ถ้าในข้อมูลจากผู้ใช้มีส่วนที่ระบุชัดเจนว่า
   "ประโยคบทพูดหลักของนักแสดง (ผู้ใช้ต้องการให้พูดหรือใช้เป็นแกนหลักข�[...]
   ...
   - ห้ามเพิ่มประโยคอื่นประกบก่อนหรือหลัง ใช้เฉพาะข้อความที่ผู้ใช้ให้�[...]
...
2) ถ้า "ไม่มี" ข้อมูลส่วนนี้อยู่ใน Prompt จากผู้ใช้
   ...
   - ให้เน้นโทนที่เหมาะสมกับสินค้าและฉาก เช่น ตลาดนัด / ออนไลน์ / คาเฟ่ ฯล��[...]
...
ถ้ามีส่วนที่พูดถึงรูปภาพหรือคำว่า "ตามรูป" ให้สมมติว่ามีรูปสินค้าจร��[...]
ถ้าข้อมูลไม่ครบ ให้คุณ "จินตนาการเติม" ให้เนียน เหมาะกับสินค้า และโทน��[...]
      `.trim();
    } else {
...
โหมด: TikTok / ตลาดนัด
งานของคุณ: 
- เปลี่ยนข้อความต่อไปนี้ให้กลายเป็น "สคริปต์โฆษณา TikTok สั้น ๆ" ความยาวประ[...]
